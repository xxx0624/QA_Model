...
def get_title_from_url(url, t_dict, url_text):
    title = ""
    if url in t_dict:
        title = t_dict[url]
    if title == "":
...
if __name__ == '__main__':
    version_num = '2-10-just-url-pure'
    filepath = '.'
    ...
    title_filepath = 'train.1.json.new'
        ...
        for line in fr:
            ...
            if line != '':
                ...
                for passage in passages:
                    ...
                    #alist.extend(lcs_list)
                    #blist.extend(lcs_list)
    ...
    #generate test data
    test_filename = filename + '_test_part_data_version_' + version_num
