...
# basic cnn & expand embedding with idf
...
version_num = '1'
train1file = '/home/zhengxing/QAModel/corpus/nlpcc16-dbqa-data/backup/train1_data_version_' + version_num
...
idf_file_path = '/home/zhengxing/QAModel/corpus/nlpcc16-dbqa-data/backup/train.word-idf'
...
def train():
    ...
    #for normal embeddings & add other features
